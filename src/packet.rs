use etherparse::{PacketBuilder, SlicedPacket, TransportSlice, NetSlice};
...
pub fn build_spoofed_packet(original_packet: &[u8], dns_response_payload: &[u8]) -> Option<Vec<u8>> {
    ...
    let builder = PacketBuilder::ipv4(src_ip, dst_ip, orig_ip.time_to_live)
